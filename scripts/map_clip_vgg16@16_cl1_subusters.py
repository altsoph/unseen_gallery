...
def __(DBSCAN, items, np, pd, plt, umap):
    ...
    dbscan = DBSCAN(eps=0.15, min_samples=10)  # Adjust eps and min_samples as needed
...
def __(defaultdict, item2cluster, items):
    ...
    with open('vgg16@16_cl1_subusters_showcase.html', 'w') as _ohtmlfh:
...
def __(NearestNeighbors, gallery, img2xy, np, nx, plt):
    ...
    with open('vgg16@16_cl1_subusters_walk.txt', 'w') as _ohtmlfh:
